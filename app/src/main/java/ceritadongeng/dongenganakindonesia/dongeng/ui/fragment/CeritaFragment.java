 ...
 */
public class CeritaFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static CeritaFragment newInstance() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        mAdView2 = (AdView)view.findViewById(R.id.adViewv);
        ...
        btnPopuler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("languange","indonesia");
    ...
    public void detail(View view, int position) {
        ...
        Log.d("cerita1",cerita.id);
        Log.d("cerita1",String.valueOf(position));
        Log.d("cerita1",cerita.title);
    ...
    private void updateList(final CeritaWrapper wrapper) {
        ...
        mAdapter.likeQuestion(new CeritaAdapter.LikeQuestion() {
            ...
            @Override
            public void OnLikeClickQuestion(final  View view, final  int position) {
        ...
        mAdapter.moreCerita(new CeritaAdapter.MoreCerita() {
            ...
            public void OnMoreClickCerita(final  View view, final  int position) {
                ...
                if (ceritaDb.exist(cerita.id)) {
                    ...
                    ceritaDb.update(cerita,"bookmark-"+cerita.type+"-indonesia");
    ...
    public void loadTask() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/cerita.php?&type=populer&languange=indonesia"+"&page="+page+"&count=15";
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList(wrapper);
                                    mCacheDb.update(wrapper.list,"populer");
                                }
                            } else {
    ...
    public void loadTask2() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/cerita.php?&languange=indonesia&page="+page +"&count=15";
        Log.d("urlnya", url);
        StringRequest mRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList2(wrapper);
                                    mCacheDb.update(wrapper.list,"terbaru");
                                }
                            } else {
                                showEmpty(getString(R.string.text_download_failed));
                            }
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListCerita("populer");
    ...
    public class LoadCacheTask2 extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                //Debug.i("Checking cache " + "home-" + mConvObject);
                wrapper = mCacheDb.getListCerita("terbaru");
                Log.d("isinya",String.valueOf(wrapper));
                result 	= 1;
            } catch (Exception e) {
                e.printStackTrace();
