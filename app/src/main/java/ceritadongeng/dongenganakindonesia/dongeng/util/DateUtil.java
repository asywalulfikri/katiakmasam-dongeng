...
public class DateUtil {
	...
	public static Date stringToDateTimeWithZone(String date) {
		if (date == null || date.equals("")) return null;
	...
	public static Date timeMilisTodate(long milis) {
		return DateUtil.stringToDateTime(DateUtil.timeMilisToString(milis));
	}
